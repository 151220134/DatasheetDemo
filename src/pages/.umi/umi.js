...
import findRoute, {
  getUrlQuery,
} from '/Users/Penelope/DatasheetDemo/node_modules/_umi-build-dev@1.13.10@umi-build-dev/lib/findRoute.js';
...
plugins.use(
  require('../../../node_modules/_umi-plugin-dva@1.9.1@umi-plugin-dva/lib/runtime'),
);
...
try {
  // Umi UI Bubble
  require('../../../node_modules/_umi-plugin-ui@1.2.10@umi-plugin-ui/lib/bubble').default(
    {
      port: 3000,
      path: '/Users/Penelope/DatasheetDemo',
      currentProject: '',
      isBigfish: undefined,
    },
  );
...
(() => {
  ...
  window.GUmiUIFlag = require('../../../node_modules/_umi-build-dev@1.13.10@umi-build-dev/lib/plugins/commands/block/sdk/flagBabelPlugin/GUmiUIFlag.js').default;
